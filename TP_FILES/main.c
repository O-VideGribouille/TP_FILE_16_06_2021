...
#define file_donnee1(File) File->fl_debut->chr_donnee //Mauvaise méthode
//cas ci-dessus, est une constente.
...
int main()
{
    ...
    printf ("\nLe premier entre est [ %s ] \n",File->fl_debut->chr_donnee);



    // Consutler le dernier element
    printf ("\nLe dernier entre est [ %s ] \n",File->fl_fin->chr_donnee);
